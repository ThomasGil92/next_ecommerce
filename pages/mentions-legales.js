      ...
      <div className={theme==="dark"?"text-white col-8 mx-auto py-5 mt-5":"text-dark col-8 mx-auto py-5 mt-5"}>
       <h2>Informations légales</h2>
        ...
        <p>
          ...
          du site <a href="http://nom_de_domaine.com/">nom_de_domaine.com</a>{" "}
          l'identité des différents intervenants dans le cadre de sa réalisation
          et de son suivi :
        </p>
        <p>
          <strong>Propriétaire</strong> : Thomas Gil – Autoentreprise – 22allée
          de la pagerie, Rueil-malmaison
          <br />
          <strong>Créateur</strong> : <a href="thomas-gil.fr">Thomas Gil</a>
          <br />
          <strong>Responsable publication</strong> : Thomas Gil –
          tgil849@gmail.com
          <br />
          Le responsable publication est une personne physique ou une personne
          morale.
          <br />
          <strong>Webmaster</strong> : Thomas Gil – tgil849@gmail.com
          <br />
          <strong>Hébergeur</strong> : Serverless – Serverless, Inc 548 Market
          Street #47111 San Francisco, CA 94104
          <br />
          Crédits : <br />
        ...
        <p>
          ...
          <a href="http://nom_de_domaine.com/">nom_de_domaine.com</a> implique
          ...
          <a href="http://nom_de_domaine.com/">nom_de_domaine.com</a> sont donc
        ...
        <p>
          ...
          décidée par Thomas Gil, qui s’efforcera alors de communiquer
          préalablement aux utilisateurs les dates et heures de l’intervention.
        </p>
        <p>
          Le site <a href="http://nom_de_domaine.com/">nom_de_domaine.com</a>{" "}
          est mis à jour régulièrement par Thomas Gil. De la même façon, les
        ...
        <p>
          Le site <a href="http://nom_de_domaine.com/">nom_de_domaine.com</a> a
          pour objet de fournir une information concernant l’ensemble des
          activités de la société.
        </p>
        <p>
          Thomas Gil s’efforce de fournir sur le site{" "}
          <a href="http://nom_de_domaine.com/">nom_de_domaine.com</a> des
        ...
        <p>
          ...
          <a href="http://nom_de_domaine.com/">nom_de_domaine.com</a> sont
          données à titre indicatif, et sont susceptibles d’évoluer. Par
          ailleurs, les renseignements figurant sur le site{" "}
          <a href="http://nom_de_domaine.com/">nom_de_domaine.com</a> ne sont
        ...
        <p>
          Thomas Gil est propriétaire des droits de propriété intellectuelle ou
        ...
        <p>
          ...
          protection des données. Le cas échéant, Thomas Gil se réserve
        ...
        <p>
          ...
          <a href="http://nom_de_domaine.com/">nom_de_domaine.com</a>, peuvent
          êtres recueillies : l'URL des liens par l'intermédiaire desquels
          l'utilisateur a accédé au site{" "}
          <a href="http://nom_de_domaine.com/">nom_de_domaine.com</a>, le
          fournisseur d'accès de l'utilisateur, l'adresse de protocole Internet
          (IP) de l'utilisateur.
        </p>
        <p>
          {" "}
          En tout état de cause Thomas Gil ne collecte des informations
        ...
        <p>
          ...
          <a href="http://nom_de_domaine.com/">nom_de_domaine.com</a> n'est
          ...
          rachat de Thomas Gil et de ses droits permettrait la transmission des
        ...
        <p>
          ...
          mis en place avec l’autorisation de Thomas Gil. Cependant, Thomas Gil
        ...
        <p>
          ...
          <a href="http://nom_de_domaine.com/">nom_de_domaine.com</a> est
        ...
        <p>
          ...
          <a href="http://nom_de_domaine.com/">nom_de_domaine.com</a> est soumis
