        ...
        <div className="col-11 col-md-9 mx-auto">
          ...
          <div className="row m-0 justify-content-around">
            <Link href={`/user/profile/commandes/${user.user._id}`}>
              <div className="col-md-4 profile-hover-color border d-flex align-items-center px-0 px-md-2 py-2 mb-4 mb-md-0">
                ...
                <div className="col-8 text-md-left text-right px-0 px-md-2">
                  ...
                  <p style={{ lineHeight: "1", marginBottom: "0px" }}>
                    Suivre l'état de votre commande, consulter votre historique
                    de commandes
                  </p>
                </div>
              </div>
            ...
            <Link href={`/user/update-address/${user.user._id}`}>
              <div className="col-md-4 profile-hover-color border d-flex align-items-center px-0 px-md-2 py-2">
                <div className="col-3 text-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="40"
