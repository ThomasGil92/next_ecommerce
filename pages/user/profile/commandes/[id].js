          ...
          {orders &&
            orders.map((order, i) => {
              return (
                <div
                  key={i}
                  className="col-10 px-0 card mx-auto my-5 text-left"
                >
                  <div className="d-flex bg-third border-bottom py-1">
                  ...
                  {order.ordered_objects.list.map((items, i) => {
                    return (
                      <div key={i} className="d-flex w-100 my-2 bg-white">
